...
func (r ApiGetCurrentCrlRequest) Execute() ([]int64, *http.Response, error) {
	return r.ApiService.GetCurrentCrlExecute(r)
}
...
func (a *CertificateRevocationListAPIService) GetCurrentCrlExecute(r ApiGetCurrentCrlRequest) ([]int64, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CertificateRevocationListAPIService.GetCurrentCrl")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/crl"
