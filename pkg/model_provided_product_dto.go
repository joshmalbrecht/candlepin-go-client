...
// checks if the ProvidedProductDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvidedProductDTO{}
...
type _ProvidedProductDTO ProvidedProductDTO
...
func (o *ProvidedProductDTO) UnmarshalJSON(data []byte) (err error) {
	...
	varProvidedProductDTO := _ProvidedProductDTO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProvidedProductDTO)

	if err != nil {
		return err
	}

	*o = ProvidedProductDTO(varProvidedProductDTO)

	return err
}

type NullableProvidedProductDTO struct {
	value *ProvidedProductDTO
	isSet bool
}
...
func NewNullableProvidedProductDTO(val *ProvidedProductDTO) *NullableProvidedProductDTO {
	return &NullableProvidedProductDTO{value: val, isSet: true}
}
